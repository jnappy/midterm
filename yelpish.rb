...
# define yelp api filter for cafes
cafes_filter_400 = {
  term: 'cafe',
  radius_filter: 400 }

response = Yelp.client.search(start_point.user_location, cafes_filter_400).raw_data

puts 'Here is what is within a qaurter mile of your address:'
puts 'Cafes: #{response['total']}'
